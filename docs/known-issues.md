...
- Existing buyer subscriptions must be canceled in Stripe before the next renewal;
  changing application access rules does not cancel external Stripe subscriptions.
