...
Buyer access and ordering are free. Stripe bills producer selling subscriptions on
the website, while Google Play bills them in the Android app. Stripe Connect is
optional for product sales. An order uses online
...
control. Buyers enter the marketplace for free. Producers subscribe with Google Play
Billing, and Cloud Functions verify and acknowledge purchases before granting the
shared Firebase entitlement.
